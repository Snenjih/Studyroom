  ...
  return (
    <>
      <button
        ...
        className={className ?? 'font-mono text-[12px] text-zinc-500 transition-colors hover:text-red-400'}
      >
        {label}
      </button>
      ...
      >
        <p className="font-mono text-[11px] uppercase tracking-wider text-red-400">{confirmTitle}</p>
